...
\midrule
R & $-2.68$ & 6.03 & $-0.31$ & 37.6\% \\
HR & $-0.82$ & 2.93 & $-0.20$ & 42.1\% \\
RBI & $-1.94$ & 6.72 & $-0.20$ & 42.0\% \\
SO & $-1.87$ & 7.45 & $+0.18$ & 57.1\% \\
TB & $-8.23$ & 15.94 & $-0.37$ & 35.7\% \\
...
\vspace{0.2cm}
\textbf{Expected category wins:} $0.376 + 0.421 + ... = 2.98$ out of 7.
\end{frame}
...
\midrule
R & $-2.68$ & $-1.68$ & 37.6\% & 40.2\% & $+2.6\%$ \\
HR & $-0.82$ & $-0.42$ & 42.1\% & 45.0\% & $+2.9\%$ \\
RBI & $-1.94$ & $-1.06$ & 42.0\% & 44.4\% & $+2.4\%$ \\
SO & $+1.87$ & $+4.11$ & 57.1\% & 64.1\% & $+7.0\%$ \\
TB & $-8.23$ & $-5.19$ & 35.7\% & 39.3\% & $+3.6\%$ \\
SB & $-1.50$ & $-0.50$ & 34.0\% & 43.1\% & $+9.1\%$ \\
OBP & $0$ & $+0.003$ & 50.0\% & 51.3\% & $+1.3\%$ \\
\bottomrule
\end{tabular}
\end{center}
...
\[
\sum \Delta P = 2.6 + 2.9 + 2.4 + 7.0 + 3.6 + 9.1 + 1.3 = \mathbf{28.9\%}
\]

Ram\'{i}rez adds 0.289 expected category wins per week vs replacement.
\end{frame}

\begin{frame}{Why SB and SO Dominate}
Ram\'{i}rez's biggest impacts:
\begin{itemize}
    \item \textbf{SB: +9.1\%} from just +1.00 SB/week
    \item \textbf{SO: +7.0\%} from $-2.24$ SO/week
\end{itemize}

\vspace{0.3cm}
Compare to HR: +2.9\% from +0.40 HR/week.
...
\begin{itemize}
    ...
    \item Opponent mean: 4.74 SB/week
    \item Difference: $-0.50$, so $z = -0.14$, $P(\text{win}) = 43\%$
\end{itemize}

\vspace{0.3cm}
The entire distribution of ``my SB $-$ opponent SB'' shifts right by 1.00 steals. Because SD is tight (2.57), this 1-steal shift moves us 9 percentage points in win probability.
\end{frame}
